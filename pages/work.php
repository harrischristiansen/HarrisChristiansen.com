					...
					<!-- Content -->
						<section id="content">
							...
							<ul>
								...
								<li>Developed express checkout with automatic word count for over 15 file types</li>
							</ul>
							...
							<ul>
								<li>Developed web application for company management and customer interactions, increasing efficiency and reducing mistakes</li>
								<li>Trained customers on portal operations</li>
							</ul>
							<a href="http://www.AGASystemsInc.com" target="_blank">www.AGASystemsInc.com</a>
							...
							<ul>
								<li>Developed company website: www.palmerchris.com</li>
								<li>Processed, traced and filed RFIs and ASIs</li>
								<li>Updated contract drawings and specifications</li>
							</ul>
							<a href="http://www.PalmerChris.com" target="_blank">www.PalmerChris.com</a>
							...
							<ul>
								<li>Updated Company Website</li>
							</ul>
							<a href="http://www.SpiveyEngineering.com" target="_blank">www.SpiveyEngineering.com</a>
